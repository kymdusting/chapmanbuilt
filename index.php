...
<!-- Top Slider
================================================== -->
<?php include("includes/tpl_slider.php"); ?>
...
<div class="site_container container home">
	<div class="slogan columns sixteen">
        <span class="tag-line">
            <hr />
            <p>Canberra's building and renovation specialists</p>
            <hr class="hr-right" />
        </span>
	</div>
    ...
    <div class="columns four">
        ...
        <p>Chapman Built offers a variety of construction services. From complete home renovations, extensions, new homes, kitchens, bathrooms and more.</p>
    ...
    <div class="columns four highlight">
        ...
        <p>Get in touch with Chapman Built to discuss your building or renovation project needs.</p>
